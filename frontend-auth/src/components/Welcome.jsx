      ...
      <main style={{
        ...
        <div style={{ 
          ...
          <h2 style={{ 
            ...
            Bienvenido, <span style={{ color: "#4f46e5" }}>{user.nombre}</span>
          </h2>
          <p style={{ 
            fontSize: 18, 
            color: "#64748b", 
              ...
              {featuredCursos.map((_, i) => (
                <button 
                  ...
                  style={{ 
                    ...
                    borderRadius: "50%", 
                    cursor: "pointer", 
                    background: i === currentSlide ? "#4f46e5" : "rgba(255,255,255,0.7)",
                    border: "none",
                    transition: "all 0.2s ease"
                  }} 
        ...
        <section>
          <div style={{
            ...
            <div style={{
              width: "4px",
              height: "32px",
              background: "linear-gradient(135deg,rgb(104, 241, 99) 0%,rgb(70, 229, 97) 100%)",
              borderRadius: "2px"
            }}></div>
            <h3 style={{
              fontSize: "28px",
              fontWeight: "700",
              background: "linear-gradient(135deg,rgb(104, 241, 99) 0%,rgb(89, 229, 70) 100%)",
              backgroundClip: "text",
              WebkitBackgroundClip: "text",
              color: "transparent"
            }}>
